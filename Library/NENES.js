...
const PAL = [
  "#3e3a3e", "#755eac", "#8d7cbd", "#928cad", "#a5a1bb", "#b7b6ca", "#c5ddc7", "#6f58a6",
  "#998dc3", "#836cbc", "#a383e9", "#484676", "#897bb1", "#8f8ae8", "#85ece6", "#edf5ee",
  "#6b413e", "#a06397", "#b77da8", "#a093be", "#b5a9cd", "#c8bfde", "#d8e8db", "#995687",
  "#a794d6", "#a86a7e", "#9f94fe", "#845773", "#b47c9f", "#978bff", "#92f8fd", "#edfaef",
  "#282828", "#29257c", "#472679", "#4c336b", "#5e4577", "#6d5784", "#787b7c", "#2a2764",
  "#52347e", "#59276b", "#8f217d", "#282835", "#44266e", "#4832a0", "#358c9e", "#9eaaad",
  "#61201d", "#612b5b", "#674674", "#665069", "#635d71", "#606a7a", "#5e8178", "#712647",
  "#655177", "#693c74", "#d2073c", "#72231f", "#6c3066", "#664f91", "#52756e", "#5c9686",
]
//  "#5e8379"

let pointer_ = { y: 0, x: 0, c: 32, ox: 0 };
let defaultControls_ = [[87, 38], [83, 40], [65, 37], [68, 39], [90, 88, 32, 13, 69], 70, 27, [9, 81]];
...
// let fntColours = [32, 16, 0, 31, 15, 47, 14, 30, 46];
let fntColours = [...Array(64).keys()];
...
function defaultMenu() {
  ...
  this.update = function () {
    ...
    palset([11, 64, 11]);
    spr(0, 32, D.H / 2 - 68, 8, 1);
    palset([11, 11, 64]);
    spr(0, 32, D.H / 2 - 52, 8, 1);
    put("by sweatersjpg", 31, D.H / 2 - 36, 0);
    ...
    textc(31);
    put("PAUSED ", 32, D.H / 2 - 20, 11);
    put("(press esc)", 0, 0, 11);
    ...
    //   put("EDIT INPUT");
    // }
    put(">", 24, D.H / 2 - 4 + (this.selected * 8), 11);
    locate(32, D.H / 2 - 4);
    put("RESET", 0, 0, 11);
...
let CORROFF = Math.floor(Math.random() * 40) + 10;

function spr(F, X, Y, SW, SH, DIR, ANG, DW, DH) {
  if (random() < CORRUPTION) F = (F + CORROFF) % 128;
  let swidth = 16
...
function put(s, x, y, c) {
  ...
  for (var i = 0; i < s.length; i++) {
    ...
    temp = { img: font[c], w: dw, h: dw, sx: sx, sy: sy, sw: sw, sh: 8, camera: Object.assign({}, camera) };
